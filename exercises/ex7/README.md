...
📋 **Action Required**: Wire navigation event to sensor list items.
...
📋 **Action Required**: Create a new controller for the SensorStatus view.
...
📋 **Action Required**: Wire up the back navigation button.
